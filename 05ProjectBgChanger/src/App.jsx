      ...
      <div className="fixed top-10 right-5">
        <div className="rounded-xl gap-4" style={{backgroundColor:"white"}}>
          <button
            ...
            className="outline-none px-4 py-1 mx-6 my-1 mt-4 rounded-xl w-28"
            style={{backgroundColor:"red", color:'white'}}>
              Red
          </button><br />
          <button
            onClick={()=>{setColor('green')}}
            className="outline-none px-4 py-1 mx-6 my-1 rounded-xl w-28"
          ...
          <button
            ...
            className="outline-none px-4 py-1 mx-6 my-1 mb-4 rounded-xl w-28"
